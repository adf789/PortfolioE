...
#define TEST_LOG(expr) UE_LOG(POE, Warning, TEXT("%s : %s"), *CALL_INFO, TEXT(""#expr""))
#define TEST_LOG_WITH_VAR(expr, ...) UE_LOG(POE, Warning, TEXT("%s : "#expr""), *CALL_INFO, ##__VA_ARGS__)